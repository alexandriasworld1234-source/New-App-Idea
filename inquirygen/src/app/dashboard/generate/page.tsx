...
function resolveFrameworkForCountry(country: string): string {
  switch (country) {
    case "US": case "PR": return "ngss";
    case "GB": return "uk_national";
    case "AU": return "acara";
    ...
    try {
      const response = await fetch("/api/generate/unit", {
        ...
        body: JSON.stringify({
          ...
          standardsFramework: resolveFrameworkForCountry(formData.country),
          selectedStandards: [],
