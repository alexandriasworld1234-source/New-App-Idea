...
const deliverables = [
  ...
  { icon: BarChart3, title: "Standards Alignment", format: null, description: "Automatically mapped to IB, UK National Curriculum, Australian Curriculum, NGSS, and U.S. state standards." },
